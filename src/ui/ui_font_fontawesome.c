 ...
 * Size: 60 px
 * Bpp: 4
 * Opts: --bpp 4 --size 60 --no-compress --font ..\..\Desktop\personal_project\electric_pass\software_design\fonts\Font Awesome 7 Free-Solid-900.otf --range 0xf013,0xf007,0xf3cf,0xf15b,0xf240-0xf244,0xf071 --format lvgl
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 5282, .adv_w = 720, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 6655, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 8298, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 9941, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 11584, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 13227, .adv_w = 1200, .box_w = 73, .box_h = 46, .ofs_x = 3, .ofs_y = -4},
    {.bitmap_index = 14906, .adv_w = 720, .box_w = 43, .box_h = 61, .ofs_x = 1, .ofs_y = -8}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0xc, 0x6a, 0x154, 0x239, 0x23a, 0x23b, 0x23c,
    0x23d, 0x3c8
};
