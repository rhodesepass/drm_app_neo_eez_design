 ...
 * Size: 60 px
 * Bpp: 4
 * Opts: --bpp 4 --size 60 --no-compress --font ..\..\Desktop\personal_project\electric_pass\software_design\fonts\Font Awesome 7 Free-Solid-900.otf --range 0xf013,0xf007,0xf3cf,0xf15b,0xf240-0xf244,0xf071,0xf0e7,0xf3e0,0xf187,0xf302,0xf185 --format lvgl
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 8410, .adv_w = 1080, .box_w = 64, .box_h = 65, .ofs_x = 2, .ofs_y = -10},
    {.bitmap_index = 10490, .adv_w = 960, .box_w = 60, .box_h = 53, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 12080, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 13723, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 15366, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 17009, .adv_w = 1200, .box_w = 73, .box_h = 45, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 18652, .adv_w = 1200, .box_w = 73, .box_h = 46, .ofs_x = 3, .ofs_y = -4},
    {.bitmap_index = 20331, .adv_w = 1080, .box_w = 64, .box_h = 57, .ofs_x = 0, .ofs_y = -8},
    {.bitmap_index = 22155, .adv_w = 720, .box_w = 43, .box_h = 61, .ofs_x = 1, .ofs_y = -8},
    {.bitmap_index = 23467, .adv_w = 720, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -8}
};
...
static const uint16_t unicode_list_0[] = {
    0x0, 0xc, 0x6a, 0xe0, 0x154, 0x17e, 0x180, 0x239,
    0x23a, 0x23b, 0x23c, 0x23d, 0x2fb, 0x3c8, 0x3d9
};
...
{
    {
        .range_start = 61447, .range_length = 986, .glyph_id_start = 1,
