 ...
 * Size: 60 px
 * Bpp: 4
 * Opts: --bpp 4 --size 60 --no-compress --font ..\..\Desktop\personal_project\electric_pass\software_design\fonts\Font Awesome 7 Free-Solid-900.otf --range 0xf013,0xf007,0xf3cf,0xf15b,0xf240-0xf244,0xf071,0xf0e7,0xf3e0 --format lvgl
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 17973, .adv_w = 720, .box_w = 45, .box_h = 61, .ofs_x = 0, .ofs_y = -8}
};
